...
//		}
//
//		gold = city.plantation * 2 + city.mine * 2+ city.population * 2 * city.market - factory_cost;
//		if (gold >= 0)
//		{
//			gold_sign = '+';
//		}
...
//		}
//
//		labor = city.mine * 3 + city.population * (1 + 2 * city.factory);
//		cout << city.name << " "
//			<< city.population << "人 "
//			<< gain_sign << gain << "粮 "
//			<< gold_sign<< gold << "金 +"
